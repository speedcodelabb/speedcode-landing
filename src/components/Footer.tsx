    ...
    <footer className="border-t border-sky-300/10 bg-[#020614] px-5 py-10 md:px-8">
      <div className="mx-auto grid max-w-[1240px] gap-8 md:grid-cols-[1.2fr_0.8fr_0.8fr]">
        ...
        <div>
          ...
          <div className="mt-4 grid gap-3 text-sm text-slate-400">
            <a href={`tel:+${content.whatsappNumber}`} className="transition hover:text-sky-300">{content.contactPhone}</a>
            <a href={`mailto:${content.contactEmail}`} className="transition hover:text-sky-300">{content.contactEmail}</a>
